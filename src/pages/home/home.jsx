...
function CategoryItem({ icon, title, description, link }) {
  return (
    <div className="h-100 text-center px-16 py-32 rounded-12 bg-main-25 border border-neutral-30 hover-border-main-600 transition-2 wow bounceInUp">
      <span className="w-96 h-96 flex-center d-inline-flex bg-white text-main-600 text-40 rounded-circle box-shadow-md mb-24">
        <img src={icon} alt={title} className="animate__flipInY" />
      </span>
    ...
    >
      ...
      <div className="course-item__content position-relative">
        <div className="d-flex align-items-center justify-content-between flex-wrap">
          <Link to="#" className="flex-align fs-5 fw-medium text-black">
            {course.instructor}
          </Link>
...
function ExploreCourses() {
  const courses = [
    {
      date: "السبت - 26/01/2025 - 10:00Am",
      time: "10:00Am",
      imgSrc: "assets/images/bg/bg-course-1.png",
      instructor: "احمد عثمان",
      rating: 4.9,
      subject: "العلوم",
      price: 150,
    ...
    {
      date: "الأحد - 27/01/2025 - 11:00Am",
      time: "11:00Am",
      imgSrc: "assets/images/bg/bg-course-2.png",
      instructor: "محمد علي",
      rating: 4.8,
      subject: "الكيمياء",
      price: 200,
    ...
    {
      date: "الاثنين - 28/01/2025 - 09:00Am",
      time: "09:00Am",
      imgSrc: "assets/images/bg/bg-course-3.png",
          ...
          <div className="row justify-content-center">
            ...
            >
              <div className="course-item bg-white rounded-16 py-12 plan-one box-shadow-md">
                <div
                  className="course-item__thumb w-100 overflow-hidden position-relative plan-one-header"
                ...
                >
                  <h1
                    ...
                    style={{ marginBottom: "30px" }}
                  >
                    الباقة الشهرية لمادة واحدة
                  </h1>
                </div>
                <div className="course-item__content position-relative">
                  <p className="mb-4">ابتداء من</p>
                  <h2 className="fs-2 text-black" style={{ marginTop: "20px" }}>
                    500 جنية مصري
                  </h2>
                  <ul
                  ...
                  <Link
                    to="/subscribe"
                    className="text-center text-light fw-light bg-plan-1 hover-bg-neutral-500 d-block w-100 join-done-btn"
                  >
                    اشتراك
                  </Link>
                </div>
            ...
            <div
              ...
              style={{ marginBottom: "30px" }}
            >
              <div className="course-item bg-white rounded-16 py-12 plan-two box-shadow-md">
                <div
                  className="course-item__thumb w-100 overflow-hidden position-relative plan-two-header"
                  style={{ marginTop: "20px" }}
                >
                  <h1
                    className="fs-4 text-center"
                ...
                <div className="course-item__content position-relative">
                  ...
                  <Link
                    to="/subscribe"
                    className="text-center text-light fw-light bg-plan-2 hover-bg-neutral-500 d-block w-100 join-done-btn"
                  >
                    اشتراك
                  </Link>
                </div>
