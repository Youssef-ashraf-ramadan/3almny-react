              ...
              <div className="pt-32 pb-24 px-16 position-relative">
                <div className="flex-align gap-14 flex-wrap mb-20">
                  <div className="flex-align gap-8">
                    ...
                    <span className="text-neutral-500 text-lg">علي مازن</span>
                  </div>
                ...
                <h2 className="mb-24 fs-2">ماهو حاصل ضرب 5 * 5 ؟</h2>
              </div>
            </div>
            ...
            <div className="border border-neutral-30 rounded-12 bg-main-25 p-32 mt-24">
              ...
              {[...Array(3)].map((_, index) => (
                <div
                  ...
                  key={index}
                >
                  <p className="text-neutral-700 fs-4">"الناتج هو ٢٥"</p>
                  ...
                  <div className="flex-align flex-wrap gap-24">
                    ...
                    />
                    <div>
                      <h6 className="text-xl mb-8 fw-medium">يوسف اشرف</h6>
