...
import { fetchLessonId, fetchLessonsSubject } from '../../redux/features/actions/lessonActions';
import Skeleton, { SkeletonTheme } from 'react-loading-skeleton';
import 'react-loading-skeleton/dist/skeleton.css'
function LessonsTeacherPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
...
function LessonLists(){
    ...
    useEffect(() => {
        if (id) {
            dispatch(fetchLessonsSubject({ id, currentPage }));
          }
                                    ...
                                    <ul className="courses-learn-list">
                                        ...
                                        <li> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                ...
                                                <path
                                                    ...
                                                    fill="#222E48" />
                                            </svg> {lesson?.price} جنيه </li>
                                    </ul>
          <Link
  to={`/course-details/${lesson.id}`}
...
export default LessonsTeacherPage;
