...
function CoursesDetails(){
 return <section className="course-details py-120">
 <div className="container">
     <div className="row gy-4 justify-content-center">
         <div className="col-lg-8 col-12">
             <div className="course-details__content   rounded-12  ">
                 <img src="assets/images/bg/zoom.png" alt="" className="rounded-8 cover-img" />
                 <div>
                     <h2 className="mt-24 mb-24">حصه رقم ٧٧</h2>
             ...
             <div className="  rounded-12" style={{ marginBottom: "100px" }} >
                 ...
                 <div className="accordion common-accordion style-three" id="accordionExampleTwo">
                     ...
                     <div className="accordion-item">
                         ...
                         <div id="collapseOneTwo" className="accordion-collapse collapse show"
                             ...
                             <div className="accordion-body p-0">
                                 <a href="javascript:void(0)"
                                     ...
                                     <span className="flex-align gap-12">
                                         <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                             <path fill-rule="evenodd" clip-rule="evenodd" d="M2.83334 0C1.54467 0 0.5 1.04467 0.5 2.33334V21.6667C0.5 22.9553 1.54467 24 2.83334 24H22.1667C23.4553 24 24.5 22.9553 24.5 21.6667V0H2.83334ZM15.4999 8.85248e-05L24.4999 8.7738e-05V9.00009L15.4999 8.85248e-05Z" fill="#F2F2F2"/>
                                             <path d="M15.5 9L24.5 9L15.5 0L15.5 9Z" fill="#BDBDBD"/>
                                             <rect x="2" y="12" width="21" height="9.75" rx="1.28336" fill="#EF4444"/>
                                             <path d="M5.53662 19.6875V14.0625H7.60754C8.03179 14.0625 8.38773 14.1431 8.67536 14.3042C8.96479 14.4653 9.1832 14.6869 9.33061 14.9689C9.47982 15.249 9.55442 15.5676 9.55442 15.9247C9.55442 16.2854 9.47982 16.6058 9.33061 16.886C9.18141 17.1661 8.96119 17.3868 8.66997 17.5479C8.37875 17.7072 8.02011 17.7869 7.59406 17.7869H6.22154V16.9492H7.45923C7.70731 16.9492 7.91045 16.9052 8.06865 16.8173C8.22684 16.7294 8.34369 16.6086 8.41919 16.4548C8.49649 16.301 8.53514 16.1243 8.53514 15.9247C8.53514 15.7251 8.49649 15.5493 8.41919 15.3973C8.34369 15.2454 8.22594 15.1273 8.06595 15.043C7.90775 14.957 7.70372 14.9139 7.45384 14.9139H6.53703V19.6875H5.53662Z" fill="white"/>
                                             <path d="M12.2948 19.6875H10.4234V14.0625H12.3325C12.8808 14.0625 13.3518 14.1751 13.7455 14.4003C14.141 14.6237 14.4448 14.9451 14.6569 15.3644C14.869 15.7837 14.9751 16.2854 14.9751 16.8695C14.9751 17.4554 14.8681 17.959 14.6542 18.3801C14.4421 18.8013 14.1356 19.1245 13.7347 19.3497C13.3356 19.5749 12.8556 19.6875 12.2948 19.6875ZM11.4238 18.8058H12.2462C12.6309 18.8058 12.9518 18.7344 13.2089 18.5916C13.4659 18.447 13.6592 18.2318 13.7886 17.9462C13.9181 17.6587 13.9828 17.2998 13.9828 16.8695C13.9828 16.4392 13.9181 16.0822 13.7886 15.7983C13.6592 15.5127 13.4677 15.2994 13.2143 15.1584C12.9626 15.0156 12.6498 14.9442 12.2759 14.9442H11.4238V18.8058Z" fill="white"/>
                                             <path d="M15.9256 19.6875V14.0625H19.4634V14.9167H16.926V16.4438H19.2207V17.298H16.926V19.6875H15.9256Z" fill="white"/>
                                             <path d="M5.53662 19.6875V14.0625H7.60754C8.03179 14.0625 8.38773 14.1431 8.67536 14.3042C8.96479 14.4653 9.1832 14.6869 9.33061 14.9689C9.47982 15.249 9.55442 15.5676 9.55442 15.9247C9.55442 16.2854 9.47982 16.6058 9.33061 16.886C9.18141 17.1661 8.96119 17.3868 8.66997 17.5479C8.37875 17.7072 8.02011 17.7869 7.59406 17.7869H6.22154V16.9492H7.45923C7.70731 16.9492 7.91045 16.9052 8.06865 16.8173C8.22684 16.7294 8.34369 16.6086 8.41919 16.4548C8.49649 16.301 8.53514 16.1243 8.53514 15.9247C8.53514 15.7251 8.49649 15.5493 8.41919 15.3973C8.34369 15.2454 8.22594 15.1273 8.06595 15.043C7.90775 14.957 7.70372 14.9139 7.45384 14.9139H6.53703V19.6875H5.53662Z" stroke="white" stroke-width="0.583334"/>
                                             <path d="M12.2948 19.6875H10.4234V14.0625H12.3325C12.8808 14.0625 13.3518 14.1751 13.7455 14.4003C14.141 14.6237 14.4448 14.9451 14.6569 15.3644C14.869 15.7837 14.9751 16.2854 14.9751 16.8695C14.9751 17.4554 14.8681 17.959 14.6542 18.3801C14.4421 18.8013 14.1356 19.1245 13.7347 19.3497C13.3356 19.5749 12.8556 19.6875 12.2948 19.6875ZM11.4238 18.8058H12.2462C12.6309 18.8058 12.9518 18.7344 13.2089 18.5916C13.4659 18.447 13.6592 18.2318 13.7886 17.9462C13.9181 17.6587 13.9828 17.2998 13.9828 16.8695C13.9828 16.4392 13.9181 16.0822 13.7886 15.7983C13.6592 15.5127 13.4677 15.2994 13.2143 15.1584C12.9626 15.0156 12.6498 14.9442 12.2759 14.9442H11.4238V18.8058Z" stroke="white" stroke-width="0.583334"/>
                                             <path d="M15.9256 19.6875V14.0625H19.4634V14.9167H16.926V16.4438H19.2207V17.298H16.926V19.6875H15.9256Z" stroke="white" stroke-width="0.583334"/>
                                             </svg>
                                         <span className="text-line-1">شرح ١</span>
                                     </span>
                                     <span className="flex-align gap-12 flex-shrink-0 mega-footer ">
                                         MB 2.4 
                                 ...
                                 <a href="javascript:void(0)"
                                     ...
                                     <span className="flex-align gap-12">
                                         ...
                                         <span className="text-line-1">شرح ٢</span>
                                     </span>
                                     <span className="flex-align gap-12 flex-shrink-0 mega-footer ">
                                         MB 2.4 
                                 ...
                                 <a href="javascript:void(0)"
                                     ...
                                     <span className="flex-align gap-12">
                                         ...
                                         <span className="text-line-1">شرح ٣</span>
                                     </span>
                                     <span className="flex-align gap-12 flex-shrink-0 mega-footer ">
                                         MB 2.4 
             ...
             <div className="border border-neutral-30 rounded-12 bg-main-25 p-32 mt-24">
                 <div className="d-flex align-items-start  flex-wrap flex-md-nowrap gap-32">
                     <img src="assets/images/bg/user.png" alt="" className="user-course-details" />
                     <div className="flex-grow-1">
                         <div className=" d-flex justify-content-between">
                             <h4 className="mb-0">احمد ابراهيم</h4>
                             <div className="dropdown flex-shrink-0">
                                 <button className="text-gray-600 text-xl d-flex rounded-4" type="button"
