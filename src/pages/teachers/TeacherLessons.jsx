...
import {  fetchTeachersBySubject } from "../../redux/features/actions/teacherActions";
import { useEffect, useState } from "react";
import { useDispatch, useSelector } from "react-redux";
import Skeleton, { SkeletonTheme } from 'react-loading-skeleton';
import 'react-loading-skeleton/dist/skeleton.css'
import { fetchLessonsTeacher } from "../../redux/features/actions/lessonActions";
  ...
  const {id}=useParams()
    ...
    const { lessons, isLoading, error } = useSelector((state) => state.lessons);
          ...
          const [currentPage, setCurrentPage] = useState(1);
            ...
            useEffect(() => {
              if (id) {
                dispatch(fetchLessonsTeacher({ teacherId: id, currentPage }));
              }
    ...
    lessons?.data?.map((lesson) => (
                ...
                <div key={lesson.id} className="col-lg-4 col-sm-6">
                    ...
                    <div className="p-24 position-relative">
                      <div className="">
                        <h4 className="mb-28 pb-24 border-bottom border-neutral-50 mb-24 border-dashed border-0">
                          <Link to={`/teacher/${lesson.id}`} className="link text-line-2">
                          { lesson?.teacher?.name }
                          </Link>
                        </h4>
      ...
      />
                        ...
                        <div className="flex-between gap-8 flex-wrap">
                          ...
                          <div className="flex-align gap-4">
                            <span className="text-lg text-neutral-700">{Number(lesson?.teacher?.max_rating).toFixed(2)}
                            </span>{" "}
